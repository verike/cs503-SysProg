...
// Answer: From my understanding, the prototypes are used to
//         pre-declare a function and inform the compiler
//         about functions that will be invoked in a program.
...
int main(int argc, char *argv[])
{
    ...
    // Answer: The default is used for invalid entries,serves as an error handler.
    default:
        usage(argv[0]);
